...
{
    public partial class Form_ShowBill : Form
    {
        ...
        public Form_ShowBill(string BillID, string AreaName, string RoomTypeName, string RoomID, string RoomName, int Months, int Years, string StaffID, int BillPaid)
        {
            InitializeComponent();
