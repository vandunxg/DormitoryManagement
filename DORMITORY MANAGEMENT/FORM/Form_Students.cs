...
namespace DORMITORY_MANAGEMENT.Page
{
    public partial class Form_Students : Form
    {
        ...
        public Form_Students(string StudentID, string StudentName, string ClassID, string SpecializationName, string StudentGender, string StudentDOB, string StudentPersonalID, string StudentEmail, string StudentPhone, string StudentAddress, string StudentLived)
