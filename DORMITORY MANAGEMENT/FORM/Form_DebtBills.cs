...
{
    public partial class Form_DebtBills : Form
    {
        public Form_DebtBills()
        {
            InitializeComponent();

            dgv_DebtBills.DataSource = DataProvider.Instance.ExcuteQuery("GetDebtBills");
        ...
        private void btn_Filter_Click(object sender, EventArgs e)
        {
            if (cmb_Months.SelectedIndex != -1 && cmb_Years.SelectedIndex != -1)
            {
                ...
                dgv_DebtBills.DataSource = DataProvider.Instance.ExcuteQuery("GetDebtBillsFilter @Months , @Years ", new object[] { Months, Years });
            }
        }
