...
{
    public partial class Page_ServicesUsage : UserControl
    {
        public Page_ServicesUsage()
        {
            InitializeComponent();
        }
        ...
        {
            Form_UpdateUsageService addServices = new Form_UpdateUsageService();
        ...
        private void dgv_Usages_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0 && e.ColumnIndex >= 0 && e.RowIndex < dgv_Usages.Rows.Count && e.ColumnIndex < dgv_Usages.Columns.Count)
            {
                ...
                Form_UsageDetail usageDetailsPage = new Form_UsageDetail(UsageID, AreaName, RoomTypeName, RoomID, ServiceName, Months, Years, Quantity);
