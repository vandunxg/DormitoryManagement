...
{
    public partial class Page_RoomManagement : UserControl
    {
        public Page_RoomManagement()
        {
            InitializeComponent();
        }
        #region Events
        ...
        {
            Form_RoomManagement addNewRoom = new Form_RoomManagement();
        ...
        {
            Card_ShowRoom cardRoom = (Card_ShowRoom)sender;
            string txt_RoomID = cardRoom.RoomID;

            Form_StudentsRoom roomStudentManager = new Form_StudentsRoom(txt_RoomID);
